...
public class MpesaApiService {
        ...
        private String getAccessToken() throws Exception {
                ...
                String credentials = env.consumerKey() + ":" + env.consumerSecret();
        ...
        private Map<String, String> generatePassword() {
                ...
                String raw = env.shortcode() + env.onlinePasskey() + timestamp;
        ...
        public JsonNode initiateStkPush(String phone, String amount) throws Exception {
                ...
                payload.put("BusinessShortCode", env.shortcode());
                ...
                payload.put("PartyB", env.shortcode());
                payload.put("PhoneNumber", phone);
                payload.put("CallBackURL", env.callbackUrl());
                ...
                System.out.println("ENTERING NI PUSH => " + payload);
                ...
                ResponseEntity<String> response = restTemplate.postForEntity(
                                env.baseUrl() + "/mpesa/stkpush/v1/processrequest",
                                entity,
                                String.class);
